...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "statement", "symbols": [if_, "comparison", "statement$ebnf$19", "statement$ebnf$20", else_, "statement$ebnf$21", "statement$ebnf$22", end, if_, "statement$ebnf$23", "statement$ebnf$24"], "postprocess": (data) => new StatementNode(new IfBlockNode(data[1], data[3], data[6]), data[10] || undefined)},
