...
export const ret: InstructionInfo = {
  ...
  forms: [
    ...
    // RET cc — conditional
    {
      ...
      operands: [],
      aliases: ['ret nz'],
      operation: ['${RESOLVE_ZF}', 'if ZF == 0', '${RET_OP}', 'end if'],
      cycles: 11,
    },
    {
      ...
      operands: [],
      aliases: ['ret z'],
      operation: ['${RESOLVE_ZF}', 'if ZF == 1', '${RET_OP}', 'end if'],
      cycles: 11,
    },
    {
      ...
      operands: [],
      aliases: ['ret nc'],
      operation: ['${RESOLVE_CF}', 'if CF == 0', '${RET_OP}', 'end if'],
      cycles: 11,
    },
    {
      ...
      operands: [],
      aliases: ['ret c'],
      operation: ['${RESOLVE_CF}', 'if CF == 1', '${RET_OP}', 'end if'],
      cycles: 11,
    },
    {
      ...
      operands: [],
      aliases: ['ret po'],
      operation: ['${RESOLVE_PF}', 'if PF == 0', '${RET_OP}', 'end if'],
      cycles: 11,
    },
    {
      ...
      operands: [],
      aliases: ['ret pe'],
      operation: ['${RESOLVE_PF}', 'if PF == 1', '${RET_OP}', 'end if'],
      cycles: 11,
    },
    {
      ...
      operands: [],
      aliases: ['ret p'],
      operation: ['${RESOLVE_SF}', 'if SF == 0', '${RET_OP}', 'end if'],
      cycles: 11,
    },
    {
      ...
      operands: [],
      aliases: ['ret m'],
      operation: ['${RESOLVE_SF}', 'if SF == 1', '${RET_OP}', 'end if'],
      cycles: 11,
    },
  ],
};
