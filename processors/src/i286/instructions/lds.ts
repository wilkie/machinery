...
// TODO: protected mode
export const lds: InstructionInfo = {
  identifier: 'lds',
  name: 'Load Doubleword Pointer into DS',
  description:
  ...
  forms: [
    // 0xC5 /r - LDS rw, ed
    {
      ...
      opcode: [Opcodes.LDS, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.LDS, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.LDS, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.LDS, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      operation: ['${UD_EXCEPTION}'],
      opcode: [Opcodes.LDS, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 1,
    },
  ],
