...
export const les: InstructionInfo = {
  ...
  forms: [
    // 0xC4 /r - LES rw, ed
    {
      ...
      opcode: [Opcodes.LES, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.LES, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.LES, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.LES, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      operation: ['${UD_EXCEPTION}'],
      opcode: [Opcodes.LES, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 1,
    },
  ],
