...
export type {
  ...
  RegisterDeclaration as AstRegisterDeclaration,
  RegisterField as AstRegisterField,
  UnitDeclaration as AstUnitDeclaration,
  TypeParameter as AstTypeParameter,
  MachineDeclaration as AstMachineDeclaration,
  MicrowordDeclaration as AstMicrowordDeclaration,
  OperandDeclaration as AstOperandDeclaration,
  OperandField as AstOperandField,
  RoutineDeclaration as AstRoutineDeclaration,
