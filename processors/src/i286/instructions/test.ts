...
export const test: InstructionInfo = {
  ...
  forms: [
    // 0x84 /r - TEST eb, rb
    {
      ...
      opcode: [Opcodes.TEST_EB_RB, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 8,
      cycles: 6,
    },
    {
      ...
      opcode: [Opcodes.TEST_EB_RB, 'ModRM_rm_reg_00'],
      operandSize: 8,
      cycles: 6,
    },
    {
      ...
      opcode: [Opcodes.TEST_EB_RB, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 8,
      cycles: 6,
    },
    {
      ...
      opcode: [Opcodes.TEST_EB_RB, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 8,
      cycles: 6,
    },
    {
      operation: ['a = ${MOD_RM_RM8}', 'b = ${MOD_RM_REG8}', '${ALU8_OP}'],
      opcode: [Opcodes.TEST_EB_RB, 'ModRM_rm_reg_11'],
      operandSize: 8,
      cycles: 2,
    },
    // 0x85 /r - TEST ew, rw
    {
      ...
      opcode: [Opcodes.TEST_EW_RW, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 6,
    },
    {
      ...
      opcode: [Opcodes.TEST_EW_RW, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 6,
    },
    {
      ...
      opcode: [Opcodes.TEST_EW_RW, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 6,
    },
    {
      ...
      opcode: [Opcodes.TEST_EW_RW, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 6,
    },
    {
      operation: ['a = ${MOD_RM_RM16}', 'b = ${MOD_RM_REG16}', '${ALU16_OP}'],
      opcode: [Opcodes.TEST_EW_RW, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 2,
    },
    // 0xA8 db - TEST AL, db
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_LOGIC_EB, 'ModRM_rm_000_11', 'IMM_u8'],
      operandSize: 8,
      cycles: 3,
    },
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_LOGIC_EW, 'ModRM_rm_000_11', 'IMM_u16'],
      operandSize: 16,
      cycles: 3,
    },
  ],
