...
export const or: InstructionInfo = {
  ...
  forms: [
    // 0x08 /r - OR eb, rb
    {
      ...
      opcode: [Opcodes.OR_EB_RB, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_EB_RB, 'ModRM_rm_reg_00'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_EB_RB, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_EB_RB, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_EB_RB, 'ModRM_rm_reg_11'],
      operandSize: 8,
      cycles: 2,
    },
    // 0x09 /r - OR ew, rw
    {
      ...
      opcode: [Opcodes.OR_EW_RW, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_EW_RW, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_EW_RW, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_EW_RW, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_EW_RW, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 2,
    },
    // 0x0A /r - OR rb, eb
    {
      ...
      opcode: [Opcodes.OR_RB_EB, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_RB_EB, 'ModRM_rm_reg_00'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_RB_EB, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_RB_EB, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_RB_EB, 'ModRM_rm_reg_11'],
      operandSize: 8,
      cycles: 2,
    },
    // 0x0B /r - OR rw, ew
    {
      ...
      opcode: [Opcodes.OR_RW_EW, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_RW_EW, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_RW_EW, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_RW_EW, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.OR_RW_EW, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 2,
    },
    // 0x0C db - OR AL, db
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_EB_DB, 'ModRM_rm_001_11', 'IMM_i8'],
      operandSize: 8,
      cycles: 3,
    },
    // 0x81 /1 dw - OR ew, dw
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_EW_DW, 'ModRM_rm_001_11', 'IMM_u16'],
      operandSize: 16,
      cycles: 3,
    },
    // 0x83 /1 db - OR ew, db
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_EW_DB, 'ModRM_rm_001_11', 'IMM_i8'],
      operandSize: 16,
      cycles: 3,
    },
  ],
