...
export const mov: InstructionInfo = {
  ...
  forms: [
      ...
      modes: {
        real: {
          operation: [
            ...
            'effective_address = ${MOD_RM_SEGMENT} + offset',
            '${SEGMENT_LIMIT_CHECK_REAL}',
            'seg_index = %{seg}', '#UD if seg_index > 3',
            'seg_index = %{seg}', '#UD if seg_index > 3',
    ...
    {
      operation: ['seg_index = %{seg}', '#UD if seg_index > 3', '${MOD_RM_RM16} = ${MOD_RM_REGS16}'],
      ...
      modes: {
        real: {
          operation: [
            'offset = %{DISP:u16}',
            'effective_address = ${MOD_RM_SEGMENT} + offset',
            'seg_index = %{seg}', '#UD if seg_index == 1 || seg_index > 3',
            '${SEGMENT_LIMIT_CHECK_REAL}',
    ...
    },
    {
      modes: {
        real: {
          operation: ['seg_index = %{seg}', '#UD if seg_index == 1 || seg_index > 3', '${MOD_RM_REGS16} = ${MOD_RM_RM16}'],
        },
        protected: {
          operation: [
            'seg_index = %{seg}', '#UD if seg_index == 1 || seg_index > 3',
