...
export const mov: InstructionInfo = {
  ...
  forms: [
    // 0x88 /r - MOV eb, rb
    {
      ...
      opcode: [Opcodes.MOV_EB_RB, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 8,
      cycles: 3,
    },
    {
      ...
      opcode: [Opcodes.MOV_EB_RB, 'ModRM_rm_reg_00'],
      operandSize: 8,
      cycles: 3,
    },
    {
      ...
      opcode: [Opcodes.MOV_EB_RB, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 8,
      cycles: 3,
    },
    {
      ...
      opcode: [Opcodes.MOV_EB_RB, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 8,
      cycles: 3,
    },
    {
      operation: ['${MOD_RM_RM8} = ${MOD_RM_REG8}'],
      opcode: [Opcodes.MOV_EB_RB, 'ModRM_rm_reg_11'],
      operandSize: 8,
      cycles: 2,
    },
    // 0x89 /r - MOV ew, rw
    {
      ...
      opcode: [Opcodes.MOV_EW_RW, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 3,
    },
    {
      ...
      opcode: [Opcodes.MOV_EW_RW, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 3,
    },
    {
      ...
      opcode: [Opcodes.MOV_EW_RW, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 3,
    },
    {
      ...
      opcode: [Opcodes.MOV_EW_RW, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 3,
    },
    {
      operation: ['${MOD_RM_RM16} = ${MOD_RM_REG16}'],
      opcode: [Opcodes.MOV_EW_RW, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 2,
    },
    // 0x8a /r - MOV rb, eb
    {
      ...
      opcode: [Opcodes.MOV_RB_EB, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 8,
      cycles: 5,
    },
    {
      ...
      opcode: [Opcodes.MOV_RB_EB, 'ModRM_rm_reg_00'],
      operandSize: 8,
      cycles: 5,
    },
    {
      ...
      opcode: [Opcodes.MOV_RB_EB, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 8,
      cycles: 5,
    },
    {
      ...
      opcode: [Opcodes.MOV_RB_EB, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 8,
      cycles: 5,
    },
    {
      operation: ['${MOD_RM_REG8} = ${MOD_RM_RM8}'],
      opcode: [Opcodes.MOV_RB_EB, 'ModRM_rm_reg_11'],
      operandSize: 8,
      cycles: 2,
    },
    // 0x8b /r - MOV rw, ew
    {
      ...
      opcode: [Opcodes.MOV_RW_EW, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 5,
    },
    {
      ...
      opcode: [Opcodes.MOV_RW_EW, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 5,
    },
    {
      ...
      opcode: [Opcodes.MOV_RW_EW, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 5,
    },
    {
      ...
      opcode: [Opcodes.MOV_RW_EW, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 5,
    },
    {
      operation: ['${MOD_RM_REG16} = ${MOD_RM_RM16}'],
      opcode: [Opcodes.MOV_RW_EW, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 2,
    },
    // 0x8c /0 - MOV ew, ES
    ...
    {
      operation: ['${MOD_RM_RM16} = ${MOD_RM_REGS16}'],
    ...
    {
      operation: ['${MOD_RM_RM8} = %{IMM}'],
      opcode: [Opcodes.MOV_EB_DB, 'ModRM_rm_000_11', 'IMM_u8'],
      operandSize: 8,
      cycles: 2,
    },
    // 0xC7 /0 db - MOV ew, dw
    ...
    {
      operation: ['${MOD_RM_RM16} = %{IMM}'],
      opcode: [Opcodes.MOV_EW_DW, 'ModRM_rm_000_11', 'IMM_u16'],
      operandSize: 16,
      cycles: 2,
    },
  ],
