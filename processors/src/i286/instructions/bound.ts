...
export const bound: InstructionInfo = {
  ...
  forms: [
    // 0x62 /r - BOUND rw, md
    {
      ...
      opcode: [Opcodes.BOUND, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 13,
    },
    {
      ...
      opcode: [Opcodes.BOUND, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 13,
    },
    {
      ...
      opcode: [Opcodes.BOUND, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 13,
    },
    {
      ...
      opcode: [Opcodes.BOUND, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 13,
    },
    {
      operation: ['${UD_EXCEPTION}'],
      opcode: [Opcodes.BOUND, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 1,
    },
  ],
