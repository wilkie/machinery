...
export const sal: InstructionInfo = {
  ...
  forms: [
    ...
    // 0xD0 /6 - SAL eb, 1 (undocumented alias)
    {
      modes: {
        real: {
          operation: [
    ...
    },
    {
      ...
      modifies: ['OF', 'CF', 'ZF', 'PF', 'SF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EB, 'ModRM_rm_110_00'],
      operands: ['rm'],
      operandSize: 8,
      cycles: 7,
    },
    ...
    },
    {
      ...
      modifies: ['OF', 'CF', 'ZF', 'PF', 'SF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EB, 'ModRM_rm8_110_11'],
      operands: ['rm'],
      operandSize: 8,
      cycles: 2,
    },
    ...
    // 0xD2 /6 - SAL eb, CL (undocumented alias)
    {
      modes: {
        real: {
          operation: [
    ...
    },
    {
      ...
      undefined: ['AF', 'OF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EB_CL, 'ModRM_rm_110_00'],
      operands: ['rm', 'CL'],
      operandSize: 8,
      cycles: 8,
    },
    ...
    },
    {
      ...
      undefined: ['AF', 'OF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EB_CL, 'ModRM_rm8_110_11'],
      operands: ['rm', 'CL'],
      operandSize: 8,
      cycles: 5,
    },
    ...
    // 0xC0 /6 - SAL eb, db (undocumented alias)
    {
      modes: {
        real: {
          operation: [
    ...
    // 0xD1 /6 - SAL ew, 1 (undocumented alias)
    {
      modes: {
        real: {
          operation: [
    ...
    },
    {
      ...
      modifies: ['OF', 'CF', 'ZF', 'PF', 'SF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EW, 'ModRM_rm_110_00'],
      operands: ['rm'],
      operandSize: 16,
      cycles: 7,
    },
    ...
    },
    {
      ...
      modifies: ['OF', 'CF', 'ZF', 'PF', 'SF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EW, 'ModRM_rm16_110_11'],
      operands: ['rm'],
      operandSize: 16,
      cycles: 2,
    },
    ...
    // 0xD3 /6 - SAL ew, CL (undocumented alias)
    {
      modes: {
        real: {
          operation: [
    ...
    },
    {
      ...
      undefined: ['AF', 'OF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EW_CL, 'ModRM_rm_110_00'],
      operands: ['rm', 'CL'],
      operandSize: 16,
      cycles: 8,
    },
    ...
    },
    {
      ...
      undefined: ['AF', 'OF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EW_CL, 'ModRM_rm16_110_11'],
      operands: ['rm', 'CL'],
      operandSize: 16,
      cycles: 5,
    },
    ...
    // 0xC1 /6 - SAL ew, db (undocumented alias)
    {
      operation: [
        'next if (%{imm} & 0x1f) == 0',
        'a = ${MOD_RM_RM16}',
