...
export const add: InstructionInfo = {
  ...
  forms: [
    ...
    // 0x80 /0 db - ADD eb, db
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_110_000_00', 'DISP_i16', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_000_00', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_000_01', 'DISP_i8', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_000_10', 'DISP_i16', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm8_000_11', 'IMM_u8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 3,
    },
