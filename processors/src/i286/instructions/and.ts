...
export const and: InstructionInfo = {
  ...
  forms: [
    ...
    // 0x80 /4 db - AND eb, db
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_110_100_00', 'DISP_i16', 'IMM_i8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_100_00', 'IMM_i8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_100_01', 'DISP_i8', 'IMM_i8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_100_10', 'DISP_i16', 'IMM_i8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm8_100_11', 'IMM_i8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 3,
    },
