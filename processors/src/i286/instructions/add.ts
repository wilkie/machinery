...
export const add: InstructionInfo = {
  ...
  forms: [
    // 0x00 /r - ADD eb, rb
    {
      ...
      opcode: [Opcodes.ADD_EB_RB, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_EB_RB, 'ModRM_rm_reg_00'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_EB_RB, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_EB_RB, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_EB_RB, 'ModRM_rm_reg_11'],
      operandSize: 8,
      cycles: 2,
    },
    // 0x01 /r - ADD ew, rw
    {
      ...
      opcode: [Opcodes.ADD_EW_RW, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_EW_RW, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_EW_RW, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_EW_RW, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_EW_RW, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 2,
    },
    // 0x02 /r - ADD rb, eb
    {
      ...
      opcode: [Opcodes.ADD_RB_EB, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_RB_EB, 'ModRM_rm_reg_00'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_RB_EB, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_RB_EB, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_RB_EB, 'ModRM_rm_reg_11'],
      operandSize: 8,
      cycles: 2,
    },
    // 0x03 /r - ADD rw, ew
    {
      ...
      opcode: [Opcodes.ADD_RW_EW, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_RW_EW, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_RW_EW, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_RW_EW, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 7,
    },
    {
      ...
      opcode: [Opcodes.ADD_RW_EW, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 2,
    },
    // 0x04 db - ADD AL, db
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_EB_DB, 'ModRM_rm_000_11', 'IMM_u8'],
      operandSize: 8,
      cycles: 3,
    },
    // 0x81 /0 dw - ADD ew, dw
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_EW_DW, 'ModRM_rm_000_11', 'IMM_u16'],
      operandSize: 16,
      cycles: 3,
    },
    // 0x83 /0 db - ADD ew, db
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_EW_DB, 'ModRM_rm_000_11', 'IMM_i8'],
      operandSize: 16,
      cycles: 3,
    },
  ],
