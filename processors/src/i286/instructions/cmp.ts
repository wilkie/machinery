...
export const cmp: InstructionInfo = {
  ...
  forms: [
    ...
    // 0x80 /7 db - CMP eb, db
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_110_111_00', 'DISP_i16', 'IMM_u8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 6,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_111_00', 'IMM_u8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 6,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_111_01', 'DISP_i8', 'IMM_u8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 6,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_111_10', 'DISP_i16', 'IMM_u8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 6,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm8_111_11', 'IMM_u8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 3,
    },
