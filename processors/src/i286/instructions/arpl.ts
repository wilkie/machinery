...
export const arpl: InstructionInfo = {
  ...
  forms: [
    // 0x63 /r - ARPL ew, rw
    {
      ...
      opcode: [Opcodes.ARPL_EW_RW, 'ModRM_110_reg_00', 'DISP_i16'],
      operandSize: 16,
      cycles: 11,
    },
    {
      ...
      opcode: [Opcodes.ARPL_EW_RW, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 11,
    },
    {
      ...
      opcode: [Opcodes.ARPL_EW_RW, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 11,
    },
    {
      ...
      opcode: [Opcodes.ARPL_EW_RW, 'ModRM_rm_reg_10', 'DISP_i16'],
      operandSize: 16,
      cycles: 11,
    },
    {
      ...
      opcode: [Opcodes.ARPL_EW_RW, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 10,
    },
  ],
