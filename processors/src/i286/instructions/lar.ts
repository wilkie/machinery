...
export const lar: InstructionInfo = {
  ...
  forms: [
    ...
    },
    {
      ...
      opcode: [Opcodes.SYSTEM, SystemOpcodes.LAR, 'ModRM_rm_reg_00'],
      operandSize: 16,
      cycles: 16,
    },
    {
      ...
      opcode: [Opcodes.SYSTEM, SystemOpcodes.LAR, 'ModRM_rm_reg_01', 'DISP_i8'],
      operandSize: 16,
      cycles: 16,
    },
    {
    ...
    },
    {
      ...
      opcode: [Opcodes.SYSTEM, SystemOpcodes.LAR, 'ModRM_rm_reg_11'],
      operandSize: 16,
      cycles: 14,
    },
  ],
