        ...
        protected: {
          ...
          operation: [
            ...
            [
              ...
              [
                '#GP if (CS & 0x0003) > desc_dpl',
                '#GP if (ES & 0x0003) > desc_dpl',
              ],
              'end if',
              ';; present check',
      ...
      modes: {
        ...
        protected: {
          ...
          operation: [
            ...
            'FETCH_IP = CS_BASE + IP',
            'CS_LIMIT_MIN = 0',
            'CS_LIMIT_MAX = RAM.GDT.gates[index].SD.limit',
            'CS_ACCESS = desc_type',
            ';; set accessed bit in GDT',
            'RAM.GDT.gates[index].SD.A = 1',
          ],
      ...
      modes: {
        ...
        protected: {
          ...
          operation: [
            ...
            '#GP if RAM.GDT.gates[index].SD.DPL != (CS & 0x0003)',
            '#GP if (SS & 0x0003) != (CS & 0x0003)',
            ';; present check',
            '#SS if RAM.GDT.gates[index].SD.P != 1',
            ';; load segment cache',
