...
export const imul: InstructionInfo = {
  ...
  forms: [
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_LOGIC_EB, 'ModRM_rm8_101_11'],
      operands: ['rm'],
      operandSize: 8,
      cycles: 13,
    },
    ...
    },
    {
      ...
      opcode: [Opcodes.ALU_LOGIC_EW, 'ModRM_rm16_101_11'],
      operands: ['rm'],
      operandSize: 16,
      cycles: 21,
    },
    ...
    // 0x6B /r db - IMUL rw, ew, db
    {
      ...
      opcode: [Opcodes.IMUL_EW_DB, 'ModRM_110_reg16_00', 'DISP_i16', 'IMM_i8'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 24,
    },
    {
      ...
      opcode: [Opcodes.IMUL_EW_DB, 'ModRM_rm_reg16_00', 'IMM_i8'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 24,
    },
    {
      ...
      opcode: [Opcodes.IMUL_EW_DB, 'ModRM_rm_reg16_01', 'DISP_i8', 'IMM_i8'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 24,
    },
    {
      ...
      opcode: [Opcodes.IMUL_EW_DB, 'ModRM_rm_reg16_10', 'DISP_i16', 'IMM_i8'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 24,
    },
    {
      ...
      opcode: [Opcodes.IMUL_EW_DB, 'ModRM_rm16_reg16_11', 'IMM_i8'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 21,
    },
    // 0x69 /r dw - IMUL rw, ew, dw
    {
      ...
      opcode: [Opcodes.IMUL_EW_DW, 'ModRM_110_reg16_00', 'DISP_i16', 'IMM_i16'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 24,
    },
    {
      ...
      opcode: [Opcodes.IMUL_EW_DW, 'ModRM_rm_reg16_00', 'IMM_i16'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 24,
    },
    {
      ...
      opcode: [Opcodes.IMUL_EW_DW, 'ModRM_rm_reg16_01', 'DISP_i8', 'IMM_i16'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 24,
    },
    {
      ...
      opcode: [Opcodes.IMUL_EW_DW, 'ModRM_rm_reg16_10', 'DISP_i16', 'IMM_i16'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 24,
    },
    {
      ...
      opcode: [Opcodes.IMUL_EW_DW, 'ModRM_rm16_reg16_11', 'IMM_i16'],
      operands: ['reg', 'rm', 'imm'],
      operandSize: 16,
      cycles: 21,
    },
