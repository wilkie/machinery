...
export const or: InstructionInfo = {
  ...
  forms: [
    ...
    // 0x80 /1 db - OR eb, db
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_110_001_00', 'DISP_i16', 'IMM_i8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_001_00', 'IMM_i8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_001_01', 'DISP_i8', 'IMM_i8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_001_10', 'DISP_i16', 'IMM_i8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm8_001_11', 'IMM_i8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 3,
    },
