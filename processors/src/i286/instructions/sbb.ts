...
export const sbb: InstructionInfo = {
  ...
  forms: [
    ...
    // 0x80 /3 db - SBB eb, db
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_110_011_00', 'DISP_i16', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_011_00', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_011_01', 'DISP_i8', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_011_10', 'DISP_i16', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm8_011_11', 'IMM_u8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 3,
    },
