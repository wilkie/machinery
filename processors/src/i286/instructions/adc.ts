...
export const adc: InstructionInfo = {
  ...
  forms: [
    ...
    // 0x80 /2 db - ADC eb, db
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_110_010_00', 'DISP_i16', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_010_00', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_010_01', 'DISP_i8', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm_010_10', 'DISP_i16', 'IMM_u8'],
      allow: ['lock'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 7,
    },
    {
      ...
      opcode: ['ALU_EB_DB', 'ModRM_rm8_010_11', 'IMM_u8'],
      operands: ['rm', 'imm'],
      operandSize: 8,
      cycles: 3,
    },
