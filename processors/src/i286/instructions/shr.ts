...
export const shr: InstructionInfo = {
  ...
  forms: [
    ...
    },
    {
      ...
      modifies: ['OF', 'CF', 'ZF', 'PF', 'SF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EB, 'ModRM_rm_101_11'],
      operandSize: 8,
      cycles: 2,
    },
    // 0xD2 /5 - SHR eb, CL
    ...
    },
    {
      ...
      undefined: ['AF', 'OF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EB_CL, 'ModRM_rm_101_11'],
      operandSize: 8,
      cycles: 5,
    },
    // 0xC0 /5 - SHR eb, db
    ...
    },
    {
      ...
      modifies: ['OF', 'CF', 'ZF', 'PF', 'SF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EW, 'ModRM_rm_101_11'],
      operandSize: 16,
      cycles: 2,
    },
    // 0xD3 /5 - SHR ew, CL
    ...
    },
    {
      ...
      undefined: ['AF', 'OF'],
      opcode: [Opcodes.ROL_ROR_RCL_RCR_SAL_SAR_SHR_EW_CL, 'ModRM_rm_101_11'],
      operandSize: 16,
      cycles: 5,
    },
    // 0xC1 /5 - SHR ew, db
